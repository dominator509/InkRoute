...
describe("tenant dashboard data projections", () => {
  ...
  it("blocks dashboard data runtime readiness until repository loaders, route wiring, and runtime evidence exist", () => {
    ...
    expect(plan.blockers).toContain("Dashboard routes still need repository wiring for: clients, appointments, payments, portfolio, travel, seo, templates, errors, releases, settings.");
