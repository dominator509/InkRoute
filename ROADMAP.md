...
- Stripe SDK installation, API version pinning, and test/live credential configuration (sandbox; gated)
...
- Provider boundary matrix for Resend, Twilio, Expo Push, and in-app delivery (planned; gated).
...
- Privacy request persistence/workers and verified export/delete/retention workflows (evidence-gated).
