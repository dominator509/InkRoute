...
- `pnpm test:unit` FAIL (`exit 1`)
  - `packages/booking/tests/booking-readiness.test.ts` â€” `Invalid booking lifecycle action complete from status draft`
  - `packages/releases/tests/feature-flags.test.ts` â€” `expected 'critical' to be 'high'`
  - `packages/payments/tests/deposit-policy.test.ts` â€” `expected 'MARAVALE-2026-00012' to contain 'MARA-VALE'`
  - `packages/observability/tests/redaction-report.test.ts` â€” `expected 'high' to be 'critical'`
